...
export default function BotSetupStep({ onNext, onBack, refreshStatus }: StepProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h4 className="text-md font-semibold text-gray-800 mb-3">Create Your Bot</h4>
        <ol className="list-decimal list-inside space-y-2 text-gray-700 bg-gray-50 p-4 rounded-lg">
          ...
          <li>Click "New Application" and give it a name (or use existing application)</li>
          <li>Go to the "Bot" section and click "Add Bot" (or "Reset Token" if bot exists)</li>
          <li>Under "TOKEN", click "Reset Token" and copy it</li>
          <li>
            <strong>Important:</strong> Enable "SERVER MEMBERS INTENT" under Privileged Gateway Intents
          </li>
          <li>Go to "OAuth2" → "General" to get your Client ID and Client Secret</li>
          <li>
            In "OAuth2" → "General" → "Redirects", ensure this is added:{' '}
